...
serve(async (req) => {
  ...
  try {
    ...
    const validatedData = {
      ...
      name_2: validateOptionalString(body.name_2, MAX_TEXT_LENGTH, 'Name 2'),
      job_title_2: validateOptionalString(body.job_title_2, MAX_TEXT_LENGTH, 'Job title 2'),
      name_3: validateOptionalString(body.name_3, MAX_TEXT_LENGTH, 'Name 3'),
      job_title_3: validateOptionalString(body.job_title_3, MAX_TEXT_LENGTH, 'Job title 3'),
